...
const Hero = () => {
  ...
  return (
    <div className="relative h-[80vh] md:h-[85vh] lg:h-[90vh] overflow-hidden">
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="container-custom h-full flex items-center relative z-10">
            <div className={`max-w-xl text-white transition-all duration-1500 ${
      ...
      <button
        onClick={prevSlide}
        className="absolute left-6 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md rounded-full p-3 text-white hover:bg-white/20 transition-colors z-20 group"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-6 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md rounded-full p-3 text-white hover:bg-white/20 transition-colors z-20 group"
